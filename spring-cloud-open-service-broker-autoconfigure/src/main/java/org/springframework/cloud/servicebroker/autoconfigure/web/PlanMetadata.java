...
public class PlanMetadata {
	...
	/**
	 * An array-of-objects that describes the costs of a service, in what currency, and the unit of measure. If there
	...
	public Map<String, Object> toModel() {
		...
		if (!CollectionUtils.isEmpty(bullets)) {
			model.put(BULLETS_KEY, bullets);
		}
		if (displayName != null) {
			model.put(DISPLAYNAME_KEY, displayName);
		}
		if (!CollectionUtils.isEmpty(properties)) {
