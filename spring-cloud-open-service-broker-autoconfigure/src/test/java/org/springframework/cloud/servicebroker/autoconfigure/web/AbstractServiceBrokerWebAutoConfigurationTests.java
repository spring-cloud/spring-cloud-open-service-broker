...
public abstract class AbstractServiceBrokerWebAutoConfigurationTests {

	private static final String ANALYZER_DESCRIPTION = String.format(
	...
	void controllersAreNotCreatedWithNonWebConfiguration() {
		nonWebApplicationContextRunner().withUserConfiguration(FullServicesConfiguration.class)
