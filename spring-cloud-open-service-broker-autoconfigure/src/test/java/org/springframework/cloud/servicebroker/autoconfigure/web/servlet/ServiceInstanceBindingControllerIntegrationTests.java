...
import org.springframework.cloud.servicebroker.autoconfigure.web.AbstractServiceInstanceBindingControllerIntegrationTests;
...
class ServiceInstanceBindingControllerIntegrationTests
		extends AbstractServiceInstanceBindingControllerIntegrationTests {
	...
	void createBindingToAppWithoutAsyncAndHeadersSucceeds(CapturedOutput output) throws Exception {
		...
		setupServiceInstanceBindingService(
				CreateServiceInstanceAppBindingResponse.builder().bindingExisted(false).build());

		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUrl(PLATFORM_INSTANCE_ID, false)).content(createRequestBody)
	...
	void createBindingToAppFiltersPlansSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUrl(PLATFORM_INSTANCE_ID, false)).content(this.createRequestBody)
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
	...
	void createBindingToAppWithAsyncAndHeadersSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUrl(PLATFORM_INSTANCE_ID, true)).content(this.createRequestBody)
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
	...
	void createBindingToAppWithExistingSucceeds() throws Exception {
		...
		setupServiceInstanceBindingService(
				CreateServiceInstanceAppBindingResponse.builder().bindingExisted(true).build());

		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUrl()).content(this.createRequestBody)
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andExpect(status().isOk())
	...
	void createBindingToRouteWithoutAsyncHeadersSucceeds() throws Exception {
		...
		setupServiceInstanceBindingService(
				CreateServiceInstanceRouteBindingResponse.builder().bindingExisted(false).build());
	...
	void createBindingToRouteWithAsyncHeadersSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUrl(null, true)).content(this.createRequestBody)
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andExpect(status().isOk())
	...
	void createBindingToRouteWithExistingSucceeds() throws Exception {
		...
		setupServiceInstanceBindingService(
				CreateServiceInstanceRouteBindingResponse.builder().bindingExisted(true).build());
	...
	void createBindingWithUnknownServiceInstanceIdFails() throws Exception {
		...
		given(this.serviceInstanceBindingService
	...
	void createBindingWithUnknownServiceDefinitionIdSucceeds() throws Exception {
		...
		this.mockMvc.perform(asyncDispatch(mvcResult))
			...
			.andExpect(jsonPath("$.description", containsString(this.serviceDefinition.getId())));
	}
	...
	void createBindingWithInvalidFieldsFails() throws Exception {
		...
		this.mockMvc.perform(put(buildCreateUrl()).content(body).contentType(MediaType.APPLICATION_JSON))
	...
	void createBindingWithMissingFieldsFails() throws Exception {
		...
		this.mockMvc
			.perform(put(buildCreateUrl()).content(body)
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncNotStarted())
			.andExpect(status().isBadRequest())
	...
	void getBindingToAppSucceeds(CapturedOutput output) throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(get(buildGetUrl(PLATFORM_INSTANCE_ID)).header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
	...
	void getBindingToAppWithParamsSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(get(buildGetUrl(PLATFORM_INSTANCE_ID, "service-definition-id", "plan-id", false))
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
	...
	void getBindingWithOperationInProgressFails() throws Exception {
		given(this.serviceInstanceBindingService.getServiceInstanceBinding(any(GetServiceInstanceBindingRequest.class)))
			.willThrow(new ServiceBrokerOperationInProgressException("task_10"));

		MvcResult mvcResult = this.mockMvc
			.perform(get(buildCreateUrl()).accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void deleteBindingWithoutAsyncAndHeadersSucceeds(CapturedOutput output) throws Exception {
		...
		this.mockMvc.perform(asyncDispatch(mvcResult)).andExpect(status().isOk()).andExpect(content().string("{}"));
	...
	void deleteBindingWithAsyncAndHeadersSucceeds() throws Exception {
		...
		setupServiceInstanceBindingService(
				DeleteServiceInstanceBindingResponse.builder().async(true).operation("working").build());

		MvcResult mvcResult = this.mockMvc
			.perform(delete(buildDeleteUrl(PLATFORM_INSTANCE_ID, true))
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON))
	...
	void deleteBindingWithUnknownInstanceIdFails() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(delete(buildDeleteUrl()).contentType(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void deleteBindingWithUnknownBindingIdFails() throws Exception {
		...
		this.mockMvc.perform(asyncDispatch(mvcResult)).andExpect(status().isGone());
	}
	...
	void deleteBindingWithMissingQueryParamsFails() throws Exception {
		...
		this.mockMvc.perform(delete(url).accept(MediaType.APPLICATION_JSON))
			.andExpect(status().isBadRequest())
	...
	void lastOperationHasSucceededStatus(CapturedOutput output) throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(
					get(buildLastOperationUrl(PLATFORM_INSTANCE_ID)).header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
						.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader()))
			.andExpect(request().asyncStarted())
			.andExpect(status().isOk())
			.andReturn();
