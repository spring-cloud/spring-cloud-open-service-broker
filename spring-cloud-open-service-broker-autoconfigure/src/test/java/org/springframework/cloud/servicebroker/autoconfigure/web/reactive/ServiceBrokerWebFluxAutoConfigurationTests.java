...
import org.springframework.cloud.servicebroker.autoconfigure.web.AbstractServiceBrokerWebAutoConfigurationTests;
...
class ServiceBrokerWebFluxAutoConfigurationTests extends AbstractServiceBrokerWebAutoConfigurationTests {

	@Test
	void controllersAreNotCreatedWithoutRequiredServices() {
		webApplicationContextRunner().run((context) -> assertThat(context.getStartupFailure())
