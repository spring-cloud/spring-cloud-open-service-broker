...
class ServiceBrokerPropertiesTests {
	...
	private void setUpCatalogProperties() {
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].metadata.longDescription",
				"service long description");
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].metadata.providerDisplayName",
				"service provider display name");
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].metadata.documentationUrl",
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].dashboard-client.redirect-uri",
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].plans[0].description",
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].plans[0].maintenance_info.description",
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].plans[1].description",
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].plans[1].metadata.displayName",
				"sample display name");
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[0].plans[1].metadata.costs[0].amount[usd]",
				"649.0");
		...
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.create.parameters[type]",
				"string");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.create.parameters[enum].0",
				"one");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.create.parameters[enum].1",
				"two");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.create.parameters[enum].2",
				"three");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.update.parameters[$schema]",
				"http://json-schema.org/draft-04/schema#");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.serviceinstance.update.parameters[type]",
				"object");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.servicebinding.create.parameters[$schema]",
				"http://json-schema.org/draft-04/schema#");
		this.map.put(
				"spring.cloud.openservicebroker.catalog.services[0].plans[1].schemas.servicebinding.create.parameters[type]",
				"object");
		...
		this.map.put("spring.cloud.openservicebroker.catalog.services[1].plans[0].description",
				"Description for Plan One");
	}
	...
	private void validateCatalogProperties(ServiceBrokerProperties properties) {
		...
		assertThat(properties.getCatalog().getServices().get(0).getRequires()).containsOnly("syslog_drain",
				"route_forwarding");
		...
		assertThat(properties.getCatalog()
			...
			.getCreate()
			.getParameters()
			.get("enum")).isInstanceOf(Map.class);
		@SuppressWarnings("unchecked")
		Map<String, String> enumMap = (Map<String, String>) properties.getCatalog()
			.getServices()
			.get(0)
			.getPlans()
			.get(1)
	...
	private void validateCatalogModel(Catalog catalog) {
		...
		assertThat(catalog.getServiceDefinitions().get(0).getMetadata()).contains(entry("key1", "value1"),
				entry("key2", "value2"));
		...
		assertThat(catalog.getServiceDefinitions().get(0).getMetadata().get("supportUrl"))
			.isEqualTo("service-support-url");
		assertThat(catalog.getServiceDefinitions().get(0).getRequires()).containsOnly("syslog_drain",
				"route_forwarding");
		...
		assertThat(catalog.getServiceDefinitions().get(0).getPlans().get(0).getDescription())
			.isEqualTo("Description for Plan One");
		assertThat(catalog.getServiceDefinitions().get(0).getPlans().get(0).getMaintenanceInfo().getVersion())
			.isEqualTo("1.0.1");
		...
		assertThat(catalog.getServiceDefinitions().get(0).getPlans().get(1).getMetadata())
			.contains(entry("key1", "value1"), entry("key2", "value2"), entry("displayName", "sample display name"));
		...
		assertThat(catalog.getServiceDefinitions()
			...
			.getCreateMethodSchema()
			.getParameters()
			.get("enum")).isInstanceOf(List.class);
		@SuppressWarnings("unchecked")
		List<String> enumList = (List<String>) catalog.getServiceDefinitions()
			.get(0)
			.getPlans()
			.get(1)
			.getSchemas()
