...
public abstract class ServiceInstanceBindingIntegrationTests extends ControllerIntegrationTests {
	...
	void setupBase() {
		...
		this.createRequestBody = JsonUtils.toJson(request);
	}
	...
	protected String buildCreateUrl(String platformInstanceId, boolean asyncAccepted) {
		return buildBaseUrl(platformInstanceId).queryParam("accepts_incomplete", asyncAccepted).toUriString();
	}
	...
	protected String buildGetUrl(String platformInstanceId, String serviceDefinitionId, String planId,
		...
		UriComponentsBuilder builder = buildBaseUrl(platformInstanceId).queryParam("accepts_incomplete", asyncAccepted);
	...
	protected String buildDeleteUrl(String platformInstanceId, boolean asyncAccepted) {
		return buildBaseUrl(platformInstanceId).queryParam("service_id", serviceDefinition.getId())
	...
	protected String buildLastOperationUrl(String platformInstanceId) {
		return buildBaseUrl(platformInstanceId).pathSegment("last_operation")
