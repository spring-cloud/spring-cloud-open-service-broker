...
public abstract class AbstractServiceInstanceBindingControllerIntegrationTests
		extends ServiceInstanceBindingIntegrationTests {
	...
	protected CreateServiceInstanceBindingRequest verifyCreateBinding() {
		...
		then(this.serviceInstanceBindingService).should().createServiceInstanceBinding(argumentCaptor.capture());
	...
	protected GetServiceInstanceBindingRequest verifyGetBinding() {
		...
		then(this.serviceInstanceBindingService).should().getServiceInstanceBinding(argumentCaptor.capture());
		return argumentCaptor.getValue();
	}
	...
	protected DeleteServiceInstanceBindingRequest verifyDeleteBinding() {
		...
		then(this.serviceInstanceBindingService).should().deleteServiceInstanceBinding(argumentCaptor.capture());
		return argumentCaptor.getValue();
	}
	...
	protected GetLastServiceBindingOperationRequest verifyLastOperation() {
		...
		then(this.serviceInstanceBindingService).should().getLastOperation(argumentCaptor.capture());
		return argumentCaptor.getValue();
	}
