...
class RequestIdentityInterceptorIntegrationTests {
	...
	void noHeaderSent() throws Exception {
		this.mockMvc.perform(get(CATALOG_PATH).accept(MediaType.APPLICATION_JSON))
	...
	void headerSent() throws Exception {
		this.mockMvc
			.perform(get(CATALOG_PATH).header(ServiceBrokerRequest.REQUEST_IDENTITY_HEADER, "request-id")
