...
class ServiceInstanceControllerIntegrationTests extends AbstractServiceInstanceControllerIntegrationTests {
	...
	void createServiceInstanceWithAsyncAndHeadersSucceeds(CapturedOutput output) throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUpdateUrl(PLATFORM_INSTANCE_ID, true)).content(createRequestBody)
	...
	void createServiceInstanceResponseShouldNotContainEmptyValuesWhenNull() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(buildCreateUpdateUrl()).content(createRequestBody)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void createServiceInstanceWithEmptyPlatformInstanceIdSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(put(url).content(createRequestBody)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void createServiceInstanceWithInvalidFieldsFails() throws Exception {
		...
		this.mockMvc
			.perform(put(buildCreateUpdateUrl()).content(body)
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
	...
	void deleteServiceInstanceWithoutAsyncAndHeadersSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(delete(buildDeleteUrl()).accept(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void updateServiceInstanceWithAsyncAndHeadersSucceeds(CapturedOutput output) throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(patch(buildCreateUpdateUrl(PLATFORM_INSTANCE_ID, true)).content(updateRequestBody)
				.header(API_INFO_LOCATION_HEADER, API_INFO_LOCATION)
				.header(ORIGINATING_IDENTITY_HEADER, buildOriginatingIdentityHeader())
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
	...
	void updateServiceInstanceWithoutSyncAndHeadersSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(patch(buildCreateUpdateUrl()).content(updateRequestBody)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
	...
	void updateServiceInstanceFiltersPlansSucceeds() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
			.perform(patch(buildCreateUpdateUrl()).content(updateRequestBodyWithPlan)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
			.andExpect(request().asyncStarted())
			.andReturn();
