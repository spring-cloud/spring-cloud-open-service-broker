...
image::https://codecov.io/gh/spring-cloud/spring-cloud-cloudfoundry-service-broker/branch/master/graph/badge.svg["Codecov", link="https://codecov.io/gh/spring-cloud/cloudfoundry-service-broker/branch/master"]
