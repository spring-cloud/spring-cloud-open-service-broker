...
=== Base path for Service Broker Controllers

By default, there is no base path for the REST controllers of the service broker implementation. There is the possibility to configure a base path for the service broker, if you want your project to be better structured.

    spring:
      cloud:
        cloudfoundry:
          servicebroker:
            basePath: /serviceBroker
