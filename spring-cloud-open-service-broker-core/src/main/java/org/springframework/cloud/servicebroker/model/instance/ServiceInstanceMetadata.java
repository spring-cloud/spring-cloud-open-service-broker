 ...
 * @see <a href=
 * "https://github.com/openservicebrokerapi/servicebroker/blob/v2.17/spec.md#service-instance-metadata">Open
...
public class ServiceInstanceMetadata {
	...
	/**
	 * Broker specific key-value pairs generated by the broker that may imply behavior
	...
	public final int hashCode() {
		return Objects.hash(this.labels, this.attributes);
	}

	@Override
	public final String toString() {
		return "ServiceInstanceMetadata{" + "labels='" + this.labels + '\'' + ", attributes='" + this.attributes + '\''
				+ '}';
	}
	...
	public static final class ServiceInstanceMetadataBuilder {
		...
		/**
		 * Add a set of attributes from the provided {@literal Map} to the metadata
		 * attributes.
		 * <p>
		 * Since OSB API 2.17.
		 * @param attributes the attributes to add
		 * @return the builder
		 * @see #attribute(String, Object)
		 */
		public ServiceInstanceMetadataBuilder attributes(Map<String, Object> attributes) {
			if (!CollectionUtils.isEmpty(attributes)) {
				this.attributes.putAll(attributes);
			}
			return this;
		...
		/**
		 * Add a key/value pair to the metadata attributes.
		 * <p>
		 * Since OSB API 2.17.
		 ...
		 * @see #attributes(Map)
		 */
		public ServiceInstanceMetadataBuilder attribute(String key, Object value) {
		...
		public ServiceInstanceMetadata build() {
			return new ServiceInstanceMetadata(this.labels, this.attributes);
		}
