...
public class Endpoint {
	 ...
	 * port range (for example "9000-9010").
	 */
	@NotEmpty
	...
	public final boolean equals(Object o) {
		...
		return Objects.equals(this.host, that.host) && Objects.equals(this.ports, that.ports)
				&& Objects.equals(this.protocol, that.protocol);
	}

	@Override
	public final int hashCode() {
		return Objects.hash(this.host, this.ports, this.protocol);
	}

	@Override
	public String toString() {
		return "Endpoint{" + "host='" + this.host + '\'' + ", ports='" + this.ports + '\'' + ", protocol="
				+ this.protocol + '\'' + '}';
	}
	...
	public static final class EndpointBuilder {
		...
		public Endpoint build() {
			return new Endpoint(this.host, this.ports, this.protocol);
		}
