 ...
 * @author Roy Clarkson
 */
public class DeleteServiceInstanceEventFlowRegistry extends
		EventFlowRegistry<DeleteServiceInstanceInitializationFlow, DeleteServiceInstanceCompletionFlow, DeleteServiceInstanceErrorFlow, DeleteServiceInstanceRequest, DeleteServiceInstanceResponse> {
