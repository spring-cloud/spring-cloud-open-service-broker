...
public enum ServiceDefinitionRequires {
	...
	/**
	 * Indicates that the service broker allows the platform to stream logs from bound
	...
	/**
	 * Indicates that the service broker allows the platform to bind routes to a service
	...
	/**
	 * Indicates that the service broker allows the platform to bind volume mounts to an
