...
public class UpdateServiceInstanceResponse extends AsyncServiceBrokerResponse {
	 ...
	 * {@literal UpdateServiceInstanceResponse}.
	 * @return the builder
	 */
	...
	public final boolean equals(Object o) {
		...
		return that.canEqual(this) && Objects.equals(this.dashboardUrl, that.dashboardUrl)
	...
	public final int hashCode() {
		return Objects.hash(super.hashCode(), this.dashboardUrl, this.metadata);
	}

	@Override
	public String toString() {
		return super.toString() + "UpdateServiceInstanceResponse{" + "dashboardUrl='" + this.dashboardUrl + '\''
	...
	public static final class UpdateServiceInstanceResponseBuilder {
		 ...
		 * @return the builder
		 */
		public UpdateServiceInstanceResponse.UpdateServiceInstanceResponseBuilder metadata(
				ServiceInstanceMetadata metadata) {
			this.metadata = metadata;
			return this;
		}
		...
		public UpdateServiceInstanceResponse build() {
			return new UpdateServiceInstanceResponse(this.async, this.operation, this.dashboardUrl, this.metadata);
		}
