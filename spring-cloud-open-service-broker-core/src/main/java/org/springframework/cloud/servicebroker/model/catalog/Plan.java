...
public class Plan {
	...
	/**
	 * Whether the Plan supports upgrade/downgrade/sidegrade to another version. This
	 * field is OPTIONAL. If specified, this takes precedence over the Service Offering's
	...
	public final boolean equals(Object o) {
		...
		return Objects.equals(this.id, plan.id) && Objects.equals(this.name, plan.name)
				&& Objects.equals(this.description, plan.description) && Objects.equals(this.metadata, plan.metadata)
				&& Objects.equals(this.free, plan.free) && Objects.equals(this.bindable, plan.bindable)
