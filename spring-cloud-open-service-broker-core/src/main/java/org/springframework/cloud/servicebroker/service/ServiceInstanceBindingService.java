...
public interface ServiceInstanceBindingService {
	...
	/**
	 * Create a new binding to a service instance. In the case of a request to create a
	 * new service instance binding with an existing binding id, the implementor should
	 * throw an {@link ServiceInstanceBindingExistsException}, which will return a
	 * {@literal HTTP 409}. If the request includes identical parameters as an existing
	 * binding, then the implementor should set
	 * {@link CreateServiceInstanceBindingResponse#isBindingExisted()}, which will result
	 * in an {@literal HTTP 200} with the populated response body.
	 * @param request containing the details of the request
	 * @return a {@link CreateServiceInstanceBindingResponse} on successful processing of
	 * the request
	 ...
	 * @throws ServiceBrokerBindingRequiresAppException if the broker only supports
	 * application binding but an app GUID is not provided in the request
	 * @throws ServiceBrokerAsyncRequiredException if the broker requires asynchronous
	...
	default Mono<CreateServiceInstanceBindingResponse> createServiceInstanceBinding(
		...
		return Mono.error(
				new UnsupportedOperationException("This service broker does not support creating service bindings."));
	}
	 ...
	 * @throws ServiceBrokerOperationInProgressException if a an operation is in progress
	...
	default Mono<GetServiceInstanceBindingResponse> getServiceInstanceBinding(
		...
		return Mono.error(
				new UnsupportedOperationException("This service broker does not support retrieving service bindings. "
	...
	default Mono<GetLastServiceBindingOperationResponse> getLastOperation(
		...
		return Mono.error(new UnsupportedOperationException(
				"This service broker does not support getting the status of " + "an asynchronous operation. "
	 ...
	 * @param request containing the details of the request
	 * @return a {@link DeleteServiceInstanceBindingResponse} on successful processing of
	 * the request
	 * @throws ServiceInstanceDoesNotExistException if a service instance with the given
	 * ID is not known to the broker
	 * @throws ServiceInstanceBindingDoesNotExistException if a binding with the given ID
	 * is not known to the broker
	 * @throws ServiceBrokerDeleteOperationInProgressException if a an operation is in
	 * progress for the service binding
	 * @throws ServiceBrokerAsyncRequiredException if the broker requires asynchronous
	 * processing of the request
	 */
	default Mono<DeleteServiceInstanceBindingResponse> deleteServiceInstanceBinding(
		...
		return Mono.error(
				new UnsupportedOperationException("This service broker does not support deleting service bindings."));
	}
