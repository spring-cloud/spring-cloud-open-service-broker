...
public class GetServiceInstanceAppBindingResponse extends GetServiceInstanceBindingResponse {
	 ...
	 * {@literal GetServiceInstanceAppBindingResponse}.
	 * @return the builder
	 */
	...
	public String toString() {
		return super.toString() + "GetServiceInstanceAppBindingResponse{" + "credentials=" + this.credentials
	 ...
	 * {@link GetServiceInstanceAppBindingResponse}.
	 */
	public static final class GetServiceInstanceAppBindingResponseBuilder {
		...
		/**
		 * Construct a {@link GetServiceInstanceAppBindingResponse} from the provided
		 * values.
		...
		public GetServiceInstanceAppBindingResponse build() {
			return new GetServiceInstanceAppBindingResponse(this.parameters, this.metadata, this.credentials,
					this.syslogDrainUrl, this.volumeMounts, this.endpoints);
		}
