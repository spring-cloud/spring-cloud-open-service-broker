 ...
 * {@literal accepts_incomplete} request parameter be {@literal true} in requests from the
 * platform.
 *
 * <p>
...
public class ServiceBrokerAsyncRequiredException extends ServiceBrokerException {
	...
	/**
	 * Error code representing that asynchronous processing is required by the service
	 * broker.
	 */
