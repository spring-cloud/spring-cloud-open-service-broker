...
class ServiceBrokerApiVersionErrorMessageTests {
	...
	@Test
	void message() {
		ServiceBrokerApiVersionErrorMessage message = ServiceBrokerApiVersionErrorMessage.from("expected-version",
				"actual-version");
		assertThat(message.toString()).isEqualTo(
	...
	@Test
	void from() {
		ServiceBrokerApiVersionErrorMessage message = ServiceBrokerApiVersionErrorMessage.from("expected-version2",
				"actual-version2");
		assertThat(message.toString()).isEqualTo(
