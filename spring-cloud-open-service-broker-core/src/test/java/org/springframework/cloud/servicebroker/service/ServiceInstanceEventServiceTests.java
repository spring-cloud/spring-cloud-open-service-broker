...
class ServiceInstanceEventServiceTests {
	...
	void setUp() {
		this.eventFlowRegistries = new EventFlowRegistries(
				...
				new AsyncOperationServiceInstanceEventFlowRegistry(new ArrayList<>(), new ArrayList<>(),
						new ArrayList<>()),
				new CreateServiceInstanceBindingEventFlowRegistry(new ArrayList<>(), new ArrayList<>(),
						new ArrayList<>()),
				new DeleteServiceInstanceBindingEventFlowRegistry(new ArrayList<>(), new ArrayList<>(),
						new ArrayList<>()),
				new AsyncOperationServiceInstanceBindingEventFlowRegistry(new ArrayList<>(), new ArrayList<>(),
						new ArrayList<>()));
		this.serviceInstanceEventService = new ServiceInstanceEventService(new BasicServiceInstanceService(),
				this.eventFlowRegistries);
	...
	void createServiceInstanceSucceeds() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.createServiceInstance(CreateServiceInstanceRequest.builder()
		...
		this.eventFlowRegistries.getCreateInstanceRegistry()
			.addInitializationFlow(new CreateServiceInstanceInitializationFlow() {
				...
				public Mono<Void> initialize(CreateServiceInstanceRequest request) {
					return ServiceInstanceEventServiceTests.this.results
						.setBeforeCreate("before " + request.getServiceInstanceId());
				}
			})
			.then(this.eventFlowRegistries.getCreateInstanceRegistry()
				.addCompletionFlow(new CreateServiceInstanceCompletionFlow() {
					...
					public Mono<Void> complete(CreateServiceInstanceRequest request,
						...
						return ServiceInstanceEventServiceTests.this.results
							.setAfterCreate("after " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getCreateInstanceRegistry()
				.addErrorFlow(new CreateServiceInstanceErrorFlow() {
					...
					public Mono<Void> error(CreateServiceInstanceRequest request, Throwable t) {
						return ServiceInstanceEventServiceTests.this.results
							.setErrorCreate("error " + request.getServiceInstanceId());
					}
				}))
			.subscribe();
	}
	...
	void createServiceInstanceFails() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.createServiceInstance(
					CreateServiceInstanceRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
	...
	void deleteServiceInstanceSucceeds() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.deleteServiceInstance(DeleteServiceInstanceRequest.builder()
				.serviceInstanceId("service-instance-id")
				.serviceDefinitionId("service-def-id")
				.build()))
		...
		this.eventFlowRegistries.getDeleteInstanceRegistry()
			.addInitializationFlow(new DeleteServiceInstanceInitializationFlow() {
				...
				public Mono<Void> initialize(DeleteServiceInstanceRequest request) {
					return ServiceInstanceEventServiceTests.this.results
						.setBeforeDelete("before " + request.getServiceInstanceId());
				}
			})
			.then(this.eventFlowRegistries.getDeleteInstanceRegistry()
				.addCompletionFlow(new DeleteServiceInstanceCompletionFlow() {
					...
					public Mono<Void> complete(DeleteServiceInstanceRequest request,
						...
						return ServiceInstanceEventServiceTests.this.results
							.setAfterDelete("after " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getDeleteInstanceRegistry()
				.addErrorFlow(new DeleteServiceInstanceErrorFlow() {
					...
					public Mono<Void> error(DeleteServiceInstanceRequest request, Throwable t) {
						return ServiceInstanceEventServiceTests.this.results
							.setErrorDelete("error " + request.getServiceInstanceId());
					}
				}))
			.subscribe();
	}
	...
	void deleteServiceInstanceFails() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.deleteServiceInstance(
					DeleteServiceInstanceRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
	...
	void updateServiceInstanceSucceeds() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.updateServiceInstance(UpdateServiceInstanceRequest.builder()
				.serviceInstanceId("service-instance-id")
				.serviceDefinitionId("service-def-id")
				.build()))
		...
		this.eventFlowRegistries.getUpdateInstanceRegistry()
			.addInitializationFlow(new UpdateServiceInstanceInitializationFlow() {
				...
				public Mono<Void> initialize(UpdateServiceInstanceRequest request) {
					return ServiceInstanceEventServiceTests.this.results
						.setBeforeUpdate("before " + request.getServiceInstanceId());
				}
			})
			.then(this.eventFlowRegistries.getUpdateInstanceRegistry()
				.addCompletionFlow(new UpdateServiceInstanceCompletionFlow() {
					...
					public Mono<Void> complete(UpdateServiceInstanceRequest request,
						...
						return ServiceInstanceEventServiceTests.this.results
							.setAfterUpdate("after " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getUpdateInstanceRegistry()
				.addErrorFlow(new UpdateServiceInstanceErrorFlow() {
					...
					public Mono<Void> error(UpdateServiceInstanceRequest request, Throwable t) {
						return ServiceInstanceEventServiceTests.this.results
							.setErrorUpdate("error " + request.getServiceInstanceId());
					}
				}))
			.subscribe();
	}
	...
	void updateServiceInstanceFails() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.updateServiceInstance(
					UpdateServiceInstanceRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
	...
	void getLastOperationSucceeds() {
		...
		StepVerifier.create(this.serviceInstanceEventService.getLastOperation(GetLastServiceOperationRequest.builder()
			.serviceInstanceId("service-instance-id")
			.serviceDefinitionId("service-def-id")
			.build())).expectNext(GetLastServiceOperationResponse.builder().build()).verifyComplete();
	...
	void getLastOperationFails() {
		...
		StepVerifier
			.create(this.serviceInstanceEventService.getLastOperation(
					GetLastServiceOperationRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
		...
		this.eventFlowRegistries.getAsyncOperationRegistry()
			.addInitializationFlow(new AsyncOperationServiceInstanceInitializationFlow() {
				...
				public Mono<Void> initialize(GetLastServiceOperationRequest request) {
					return ServiceInstanceEventServiceTests.this.results
						.setBeforeLastOperation("before " + request.getServiceInstanceId());
				}
			})
			.then(this.eventFlowRegistries.getAsyncOperationRegistry()
				.addCompletionFlow(new AsyncOperationServiceInstanceCompletionFlow() {
					...
					public Mono<Void> complete(GetLastServiceOperationRequest request,
						...
						return ServiceInstanceEventServiceTests.this.results
							.setAfterLastOperation("after " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getAsyncOperationRegistry()
				.addErrorFlow(new AsyncOperationServiceInstanceErrorFlow() {
					...
					public Mono<Void> error(GetLastServiceOperationRequest request, Throwable t) {
						return ServiceInstanceEventServiceTests.this.results
							.setErrorLastOperation("error " + request.getServiceInstanceId());
					}
				}))
			.subscribe();
	}

	private static final class BasicServiceInstanceService implements ServiceInstanceService {
