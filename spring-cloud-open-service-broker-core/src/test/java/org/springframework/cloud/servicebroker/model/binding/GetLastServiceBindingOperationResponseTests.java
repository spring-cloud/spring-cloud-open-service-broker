...
class GetLastServiceBindingOperationResponseTests {

	@Test
	void responseWithDefaultsIsBuilt() {
		GetLastServiceBindingOperationResponse response = GetLastServiceBindingOperationResponse.builder().build();
	...
	void responseWithAllValuesIsDeserialized() {
		GetLastServiceBindingOperationResponse response = JsonUtils
			.readTestDataFile("getLastBindingOperationResponse.json", GetLastServiceBindingOperationResponse.class);
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(GetLastServiceBindingOperationResponse.class).verify();
	}
