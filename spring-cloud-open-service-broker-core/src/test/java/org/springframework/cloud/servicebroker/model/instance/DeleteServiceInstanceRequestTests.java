...
class DeleteServiceInstanceRequestTests {

	@Test
	void requestWithDefaultsIsBuilt() {
		DeleteServiceInstanceRequest request = DeleteServiceInstanceRequest.builder().build();
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(DeleteServiceInstanceRequest.class)
