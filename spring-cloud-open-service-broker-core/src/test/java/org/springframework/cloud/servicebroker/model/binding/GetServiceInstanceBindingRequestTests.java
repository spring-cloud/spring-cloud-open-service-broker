...
class GetServiceInstanceBindingRequestTests {

	@Test
	void requestWithDefaultsIsBuilt() {
		GetServiceInstanceBindingRequest request = GetServiceInstanceBindingRequest.builder().build();
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(GetServiceInstanceBindingRequest.class)
