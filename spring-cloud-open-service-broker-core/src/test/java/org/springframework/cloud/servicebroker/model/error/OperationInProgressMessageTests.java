...
class OperationInProgressMessageTests {
	...
	void operationExceedsMaxAllowedLength() {
		assertThatIllegalArgumentException()
			.isThrownBy(() -> new OperationInProgressMessage(RandomString.make(10_001)));
	}
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(OperationInProgressMessage.class).verify();
	}
