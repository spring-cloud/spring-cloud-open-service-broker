...
class ServiceInstanceControllerResponseCodeTests {
	...
	@BeforeEach
	void setUp() {
		this.controller = new ServiceInstanceController(this.catalogService, this.serviceInstanceService);
	...
	void createServiceInstanceWithInstanceExistResponseGivesExpectedStatus() {
		validateCreateServiceInstanceWithResponseStatus(
				CreateServiceInstanceResponse.builder().async(false).instanceExisted(true).build(), HttpStatus.OK);
	}
	...
	void createServiceInstanceWithResponseAsyncInstanceExistGivesExpectedStatus() {
		validateCreateServiceInstanceWithResponseStatus(
				CreateServiceInstanceResponse.builder().async(true).instanceExisted(true).build(), HttpStatus.ACCEPTED);
	}
	...
	private void validateCreateServiceInstanceWithResponseStatus(CreateServiceInstanceResponse response,
		...
		given(this.serviceInstanceService.createServiceInstance(any(CreateServiceInstanceRequest.class)))
		...
		ResponseEntity<CreateServiceInstanceResponse> responseEntity = this.controller
			.createServiceInstance(this.pathVariables, null, false, null, null, null, createRequest)
			.block();

		then(this.serviceInstanceService).should().createServiceInstance(any(CreateServiceInstanceRequest.class));
	...
	@Test
	void createServiceInstanceDoesNotAddRetryAfterHeader() {
		given(this.serviceInstanceService.createServiceInstance(any(CreateServiceInstanceRequest.class)))
			.willReturn(Mono.just(CreateServiceInstanceResponse.builder().async(true).operation("creating").build()));
	...
	private void validateGetServiceInstanceWithResponseStatus(GetServiceInstanceResponse response,
		...
		given(this.serviceInstanceService.getServiceInstance(any(GetServiceInstanceRequest.class)))
			.willReturn(responseMono);

		ResponseEntity<GetServiceInstanceResponse> responseEntity = this.controller
			.getServiceInstance(this.pathVariables, null, null, null, null, null, null)
			.block();
	...
	void deleteServiceInstanceWithResponseGivesExpectedStatus() {
		validateDeleteServiceInstanceWithResponseStatus(DeleteServiceInstanceResponse.builder().async(false).build(),
				HttpStatus.OK);
	}

	@Test
	void deleteServiceInstanceWithAsyncResponseGivesExpectedStatus() {
		validateDeleteServiceInstanceWithResponseStatus(
				DeleteServiceInstanceResponse.builder().async(true).operation("deleting").build(), HttpStatus.ACCEPTED);
	}
	...
	private void validateDeleteServiceInstanceWithResponseStatus(DeleteServiceInstanceResponse response,
		...
		given(this.serviceInstanceService.deleteServiceInstance(any(DeleteServiceInstanceRequest.class)))
			.willReturn(responseMono);

		ResponseEntity<DeleteServiceInstanceResponse> responseEntity = this.controller
			.deleteServiceInstance(this.pathVariables, null, "service-definition-id", "service-definition-plan-id",
	...
	void updateServiceInstanceWithResponseGivesExpectedStatus() {
		validateUpdateServiceInstanceWithResponseStatus(UpdateServiceInstanceResponse.builder().async(false).build(),
				HttpStatus.OK);
	}

	@Test
	void updateServiceInstanceWithAsyncResponseGivesExpectedStatus() {
		validateUpdateServiceInstanceWithResponseStatus(
				UpdateServiceInstanceResponse.builder().async(true).operation("updating").build(), HttpStatus.ACCEPTED);
	}
	...
	private void validateUpdateServiceInstanceWithResponseStatus(UpdateServiceInstanceResponse response,
		...
		given(this.serviceInstanceService.updateServiceInstance(any(UpdateServiceInstanceRequest.class)))
			.willReturn(responseMono);
		...
		ResponseEntity<UpdateServiceInstanceResponse> responseEntity = this.controller
			.updateServiceInstance(this.pathVariables, null, false, null, null, null, updateRequest)
			.block();
	...
	void getLastOperationWithRetryAfterAddsHeader() {
		given(this.serviceInstanceService.getLastOperation(any(GetLastServiceOperationRequest.class)))
			.willReturn(Mono.just(GetLastServiceOperationResponse.builder()
				.operationState(OperationState.IN_PROGRESS)
				.retryAfter(30)
				.build()));

		ResponseEntity<GetLastServiceOperationResponse> responseEntity = this.controller
			.getServiceInstanceLastOperation(this.pathVariables, null, null, null, null, null, null, null)
			.block();
	...
	void getLastOperationWithoutRetryAfterOmitsHeader() {
		given(this.serviceInstanceService.getLastOperation(any(GetLastServiceOperationRequest.class))).willReturn(Mono
	...
	void getLastOperationWithUnknownInstanceGivesExpectedStatus() {
		...
		ResponseEntity<GetLastServiceOperationResponse> responseEntity = this.controller
			.getServiceInstanceLastOperation(this.pathVariables, null, "service-definition-id",
	...
	void getLastOperationWithFailedResponseGivesExpectedStatus() {
		validateGetLastOperationWithResponseStatus(
				GetLastServiceOperationResponse.builder().operationState(OperationState.FAILED).build(), HttpStatus.OK);
	}
