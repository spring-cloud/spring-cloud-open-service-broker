...
class AsyncParameterizedServiceInstanceRequestTests {

	@Test
	void requestWithCloudFoundryContextIsDeserializedFromJson() {
		AsyncParameterizedServiceInstanceRequest request = JsonUtils
			.readTestDataFile("requestWithParametersAndCloudFoundryContext.json", CreateServiceInstanceRequest.class);
	...
	void requestWithKubernetesContextIsDeserializedFromJson() {
		AsyncParameterizedServiceInstanceRequest request = JsonUtils.readTestDataFile(
				"requestWithEmptyParametersAndKubernetesContext.json", CreateServiceInstanceRequest.class);
	...
	void requestWithUnknownContextIsDeserializedFromJson() {
		AsyncParameterizedServiceInstanceRequest request = JsonUtils.readTestDataFile("requestWithCustomContext.json",
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(AsyncParameterizedServiceInstanceRequest.class)
