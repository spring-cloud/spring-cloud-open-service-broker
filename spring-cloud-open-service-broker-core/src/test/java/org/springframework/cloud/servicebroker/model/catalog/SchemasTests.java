...
class SchemasTests {
	...
	void allSchemaFieldsIsSerializedToJson() {
		...
		assertThat(schemas.getServiceInstanceSchema().getCreateMethodSchema().getParameters().get("$schema"))
			.isEqualTo("http://json-schema.org/draft-04/schema#");
		assertThat(schemas.getServiceInstanceSchema().getCreateMethodSchema().getParameters().get("type"))
			.isEqualTo("object");
		assertThat(schemas.getServiceInstanceSchema().getCreateMethodSchema().getParameters().get("description"))
			.isEqualTo("create time schema");

		assertThat(schemas.getServiceInstanceSchema().getUpdateMethodSchema().getParameters().get("$schema"))
			.isEqualTo("http://json-schema.org/draft-04/schema#");
		assertThat(schemas.getServiceInstanceSchema().getUpdateMethodSchema().getParameters().get("type"))
			.isEqualTo("object");
		assertThat(schemas.getServiceInstanceSchema().getUpdateMethodSchema().getParameters().get("description"))
			.isEqualTo("update time schema");

		assertThat(schemas.getServiceBindingSchema().getCreateMethodSchema().getParameters().get("$schema"))
			.isEqualTo("http://json-schema.org/draft-04/schema#");
		assertThat(schemas.getServiceBindingSchema().getCreateMethodSchema().getParameters().get("type"))
			.isEqualTo("object");
		assertThat(schemas.getServiceBindingSchema().getCreateMethodSchema().getParameters().get("description"))
			.isEqualTo("bind create time schema");
		...
		assertThat(json).hasPath("$.service_instance.create.parameters.properties.billing-account.type")
			.isEqualTo("string");
		assertThat(json).hasPath("$.service_instance.create.parameters.description").isEqualTo("create time schema");

		assertThat(json).hasMapAtPath("$.service_instance.update.parameters")
			.contains(entry("$schema", "http://json-schema.org/draft-04/schema#"), entry("type", "object"),
					entry("description", "update time schema"));
		assertThat(json).hasMapAtPath("$.service_binding.create.parameters")
			.contains(entry("$schema", "http://json-schema.org/draft-04/schema#"), entry("type", "object"),
