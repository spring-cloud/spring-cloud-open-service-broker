...
class ServiceInstanceBindingControllerRequestTests extends ControllerRequestTests {
	...
	void createServiceBindingParametersAreMappedToRequest() {
		...
		CreateServiceInstanceBindingRequest expectedRequest = buildCreateRequest().asyncAccepted(true)
		...
		controller.createServiceInstanceBinding(this.pathVariables, "service-instance-id", "binding-id", true,
				"api-info-location", encodeOriginatingIdentity(this.identityContext), "request-id", parsedRequest);
	}
	...
	void createServiceBindingWithInvalidPlanIdThrowsException() {
		...
		assertThatException()
			.isThrownBy(
					() -> controller
						.createServiceInstanceBinding(this.pathVariables, null, null, false, null,
								encodeOriginatingIdentity(this.identityContext), "request-id", createRequest)
						.block())
	...
	void getServiceBindingParametersAreMappedToRequest() {
		...
		controller.getServiceInstanceBinding(this.pathVariables, "service-instance-id", "binding-id",
				"service-definition-id", "plan-id", "api-info-location",
				encodeOriginatingIdentity(this.identityContext), "request-id");
	}
	...
	void deleteServiceBindingParametersAreMappedToRequest() {
		...
		controller.deleteServiceInstanceBinding(this.pathVariables, "service-instance-id", "binding-id",
				this.serviceDefinition.getId(), "plan-id", true, "api-info-location",
				encodeOriginatingIdentity(this.identityContext), "request-id");
	}
	...
	void deleteServiceBindingWithInvalidServiceDefinitionIdThrowsException() {
		...
		assertThatException()
			.isThrownBy(() -> controller
				.deleteServiceInstanceBinding(pathVariables, null, null, "unknown-service-definition-id", null, false,
						null, null, null)
				.block())
			.isInstanceOf(ServiceDefinitionDoesNotExistException.class);
	}
	...
	void deleteServiceBindingWithInvalidPlanIdThrowsException() {
		...
		assertThatException()
			.isThrownBy(() -> controller
				.deleteServiceInstanceBinding(pathVariables, null, null, "service-definition-id", "unknown-plan-id",
