...
class GetLastServiceBindingOperationRequestTests {

	@Test
	void requestWithDefaultsIsBuilt() {
		GetLastServiceBindingOperationRequest request = GetLastServiceBindingOperationRequest.builder().build();
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(GetLastServiceOperationRequest.class)
