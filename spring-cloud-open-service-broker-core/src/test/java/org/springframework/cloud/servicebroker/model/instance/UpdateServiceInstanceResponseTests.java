...
class UpdateServiceInstanceResponseTests {
	...
	void responseWithAllValuesIsDeserialized() {
		UpdateServiceInstanceResponse response = JsonUtils.readTestDataFile("updateResponse.json",
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(UpdateServiceInstanceResponse.class).withRedefinedSuperclass().verify();
	}
