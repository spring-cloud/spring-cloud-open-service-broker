...
class ErrorMessageTests {
	...
	void errorWithCodeAndDescriptionIsBuiltWithBuilder() {
		ErrorMessage errorMessage = ErrorMessage.builder().error("ErrorCode").message("error description").build();
	...
	void errorWithDescriptionIsBuiltWithBuilder() {
		ErrorMessage errorMessage = ErrorMessage.builder().message("error description").build();
	...
	void equalsAndHashCode() {
		EqualsVerifier.forClass(ErrorMessage.class).verify();
	}
