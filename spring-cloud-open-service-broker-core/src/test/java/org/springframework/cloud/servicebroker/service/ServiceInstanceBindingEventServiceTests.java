...
class ServiceInstanceBindingEventServiceTests {
	...
	void setUp() {
		...
		this.serviceInstanceBindingEventService = new ServiceInstanceBindingEventService(
				new BasicServiceInstanceBindingService(), this.eventFlowRegistries);
	...
	void createServiceInstanceBindingSucceeds() {
		...
		StepVerifier.create(this.serviceInstanceBindingEventService
			.createServiceInstanceBinding(CreateServiceInstanceBindingRequest.builder()
	...
	void createServiceInstanceBindingFails() {
		...
		StepVerifier
			.create(this.serviceInstanceBindingEventService.createServiceInstanceBinding(
					CreateServiceInstanceBindingRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
	...
	void getServiceInstanceBinding() {
		StepVerifier.create(this.serviceInstanceBindingEventService
			.getServiceInstanceBinding(GetServiceInstanceBindingRequest.builder()
				.serviceInstanceId("service-instance-id")
	...
	void getLastOperationSucceeds() {
		...
		StepVerifier.create(
				this.serviceInstanceBindingEventService.getLastOperation(GetLastServiceBindingOperationRequest.builder()
	...
	void getLastOperationFails() {
		...
		StepVerifier
			.create(this.serviceInstanceBindingEventService.getLastOperation(
					GetLastServiceBindingOperationRequest.builder().bindingId("service-instance-id").build()))
			.expectError()
			.verify();
		...
		this.eventFlowRegistries.getAsyncOperationBindingRegistry()
			.addInitializationFlow(new AsyncOperationServiceInstanceBindingInitializationFlow() {
				...
				public Mono<Void> initialize(GetLastServiceBindingOperationRequest request) {
					return ServiceInstanceBindingEventServiceTests.this.results
						.setBeforeLastOperation("before " + request.getBindingId());
				}
			})
			.then(this.eventFlowRegistries.getAsyncOperationBindingRegistry()
				.addCompletionFlow(new AsyncOperationServiceInstanceBindingCompletionFlow() {
					...
					public Mono<Void> complete(GetLastServiceBindingOperationRequest request,
						...
						return ServiceInstanceBindingEventServiceTests.this.results
							.setAfterLastOperation("after " + request.getBindingId());
					}
				}))
			.then(this.eventFlowRegistries.getAsyncOperationBindingRegistry()
				.addErrorFlow(new AsyncOperationServiceInstanceBindingErrorFlow() {
					...
					public Mono<Void> error(GetLastServiceBindingOperationRequest request, Throwable t) {
						return ServiceInstanceBindingEventServiceTests.this.results
							.setErrorLastOperation("error " + request.getBindingId());
					}
				}))
			.subscribe();
	}
	...
	void deleteServiceInstanceBindingSucceeds() {
		...
		StepVerifier.create(this.serviceInstanceBindingEventService
			.deleteServiceInstanceBinding(DeleteServiceInstanceBindingRequest.builder()
				.serviceInstanceId("service-instance-id")
				.bindingId("service-binding-id")
				.build()))
	...
	void deleteServiceInstanceBindingFails() {
		...
		StepVerifier
			.create(this.serviceInstanceBindingEventService.deleteServiceInstanceBinding(
					DeleteServiceInstanceBindingRequest.builder().serviceInstanceId("service-instance-id").build()))
			.expectError()
			.verify();
		...
		this.eventFlowRegistries.getCreateInstanceBindingRegistry()
			.addInitializationFlow(new CreateServiceInstanceBindingInitializationFlow() {
				...
				public Mono<Void> initialize(CreateServiceInstanceBindingRequest request) {
					return ServiceInstanceBindingEventServiceTests.this.results
						.setBeforeCreate("before create " + request.getServiceInstanceId());
				}
			})
			.then(this.eventFlowRegistries.getCreateInstanceBindingRegistry()
				.addErrorFlow(new CreateServiceInstanceBindingErrorFlow() {
					...
					public Mono<Void> error(CreateServiceInstanceBindingRequest request, Throwable t) {
						return ServiceInstanceBindingEventServiceTests.this.results
							.setErrorCreate("error create " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getCreateInstanceBindingRegistry()
				.addCompletionFlow(new CreateServiceInstanceBindingCompletionFlow() {
					...
					public Mono<Void> complete(CreateServiceInstanceBindingRequest request,
						...
						return ServiceInstanceBindingEventServiceTests.this.results
							.setAfterCreate("after create " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getDeleteInstanceBindingRegistry()
				.addInitializationFlow(new DeleteServiceInstanceBindingInitializationFlow() {
					...
					public Mono<Void> initialize(DeleteServiceInstanceBindingRequest request) {
						return ServiceInstanceBindingEventServiceTests.this.results
							.setBeforeDelete("before delete " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getDeleteInstanceBindingRegistry()
				.addErrorFlow(new DeleteServiceInstanceBindingErrorFlow() {
					...
					public Mono<Void> error(DeleteServiceInstanceBindingRequest request, Throwable t) {
						return ServiceInstanceBindingEventServiceTests.this.results
							.setErrorDelete("error delete " + request.getServiceInstanceId());
					}
				}))
			.then(this.eventFlowRegistries.getDeleteInstanceBindingRegistry()
				.addCompletionFlow(new DeleteServiceInstanceBindingCompletionFlow() {
					...
					public Mono<Void> complete(DeleteServiceInstanceBindingRequest request,
						...
						return ServiceInstanceBindingEventServiceTests.this.results
							.setAfterDelete("after delete " + request.getServiceInstanceId());
					}
				}))
			.subscribe();
	}
