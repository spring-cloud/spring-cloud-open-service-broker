...
class CatalogControllerTests {
	...
	private void validateServiceOne(ReadContext ctx) {
		...
		assertThat(ctx.read("$.services[0].dashboard_client.redirect_uri", String.class))
	...
	private void validateServiceOneMetadata(ReadContext ctx) {
		...
		assertThat(ctx.read("$.services[0].metadata.longDescription", String.class))
			.isEqualTo("service long description");
		assertThat(ctx.read("$.services[0].metadata.providerDisplayName", String.class))
			.isEqualTo("service provider display name");
		assertThat(ctx.read("$.services[0].metadata.documentationUrl", String.class))
	...
	private void validateServiceOnePlans(ReadContext ctx) {
		...
		assertThat(ctx.read("$.services[0].plans[0].maintenance_info.description", String.class))
		...
		assertThat(ctx.read("$.services[0].plans[1].metadata.displayName", String.class))
		...
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.create.parameters.$schema", String.class))
		...
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.create.parameters.type", String.class))
			.isEqualTo("string");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.create.parameters.enum[0]", String.class))
			.isEqualTo("one");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.create.parameters.enum[1]", String.class))
			.isEqualTo("two");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.create.parameters.enum[2]", String.class))
			.isEqualTo("three");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.update.parameters.$schema", String.class))
			.isEqualTo("http://json-schema.org/draft-04/schema#");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_instance.update.parameters.type", String.class))
			.isEqualTo("object");
		assertThat(ctx.read("$.services[0].plans[1].schemas.service_binding.create.parameters.$schema", String.class))
			.isEqualTo("http://json-schema.org/draft-04/schema#");
