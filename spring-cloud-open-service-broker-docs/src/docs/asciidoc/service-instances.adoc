...
==== Event Registry
Service instance creation can be further customized by utilizing events. Autowire the {scosb-api-service-events}/CreateServiceInstanceEventFlowRegistry.html[CreateServiceInstanceEventFlowRegistry] bean. Use the {scosb-api-service-events}/EventFlowRegistry.html#addInitializationFlow-I-[addInitializationFlow()], {scosb-api-service-events}/EventFlowRegistry.html#addCompletionFlow-C-[addCompletionFlow()] or {scosb-api-service-events}/EventFlowRegistry.html#addErrorFlow-E-[addErrorFlow()] methods to register custom reactive flows for execution during the various stages of creating a service instance.
...
==== Event Registry
Service instance updates can be further customized by utilizing events. Autowire the {scosb-api-service-events}/UpdateServiceInstanceEventFlowRegistry.html[UpdateServiceInstanceEventFlowRegistry] bean. Use the {scosb-api-service-events}/EventFlowRegistry.html#addInitializationFlow-I-[addInitializationFlow()], {scosb-api-service-events}/EventFlowRegistry.html#addCompletionFlow-C-[addCompletionFlow()] or {scosb-api-service-events}/EventFlowRegistry.html#addErrorFlow-E-[addErrorFlow()] methods to register custom reactive flows for execution during the various stages of updating a service instance.
...
==== Event Registry
Service instance deletion can be further customized by utilizing events. Autowire the {scosb-api-service-events}/DeleteServiceInstanceEventFlowRegistry.html[DeleteServiceInstanceEventFlowRegistry] bean. Use the {scosb-api-service-events}/EventFlowRegistry.html#addInitializationFlow-I-[addInitializationFlow()], {scosb-api-service-events}/EventFlowRegistry.html#addCompletionFlow-C-[addCompletionFlow()] or {scosb-api-service-events}/EventFlowRegistry.html#addErrorFlow-E-[addErrorFlow()] methods to register custom reactive flows for execution during the various stages of deleting a service instance.
...
==== Event Registry
Service instance last operation requests can be further customized by utilizing events. Autowire the {scosb-api-service-events}/AsyncOperationServiceInstanceEventFlowRegistry.html[AsyncOperationServiceInstanceEventFlowRegistry] bean. Use the {scosb-api-service-events}/EventFlowRegistry.html#addInitializationFlow-I-[addInitializationFlow()], {scosb-api-service-events}/EventFlowRegistry.html#addCompletionFlow-C-[addCompletionFlow()] or {scosb-api-service-events}/EventFlowRegistry.html#addErrorFlow-E-[addErrorFlow()] methods to register custom reactive flows for execution during the various stages of last operation retrieval.
...
There are multiple ways to configure service instance event flows. One option is to autowire one or more registries and interact with the registry directly. Another option is to define beans for specific flows. These beans will be identified and added to the appropriate registry automatically. A final option is to declare a new registry bean itself, however be aware that defining a new registry bean will override the provided auto-configuration.
