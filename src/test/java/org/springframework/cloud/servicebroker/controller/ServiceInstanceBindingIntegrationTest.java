...
public abstract class ServiceInstanceBindingIntegrationTest
		extends ControllerIntegrationTest {
	...
	public void setupBase() {
		...
		deleteRequest = ServiceInstanceBindingFixture
				.buildDeleteServiceInstanceBindingRequest();
	}
	...
	protected String buildUrl(DeleteServiceInstanceBindingRequest request,
		...
		return builder.path(request.getBindingId())
				...
				.queryParam("plan_id", request.getPlanId()).toUriString();
	}
}
