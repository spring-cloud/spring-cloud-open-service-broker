...
public class PlanFixture {
	...
	public static Plan getPlanTwo() {
        ...
        ServiceBindingSchema serviceBindingSchema = new ServiceBindingSchema(new MethodSchema(createBindingSchema));
		Schemas schemas = new Schemas(serviceInstanceSchema, serviceBindingSchema);

		return new Plan("plan-two-id", "Plan Two", "Description for Plan Two", metadata, false, true, schemas);
	}
